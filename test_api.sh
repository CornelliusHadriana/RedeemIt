...
echo -e "\n\n4. Getting all gift cards..."
# 4. Get all gift cards
curl -X GET "$BASE_URL/giftcards/" \
  -H "Authorization: Bearer $TOKEN"

echo -e "\n\n5. Getting gift card by ID (id=1)..."
# 5. Get gift card by ID
curl -X GET "$BASE_URL/giftcards/1" \
  -H "Authorization: Bearer $TOKEN"

echo -e "\n\n6. Logging a transaction of $5.00..."
# 6. Log a transaction
...
echo -e "\n\n7. Getting all transactions for gift card id 1..."
